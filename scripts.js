...
function load() {
    ...
    setInterval(async () => { searchbar(); }, 6000);
    ...
    setTimeout(async function () { $("#loader-wrapper").fadeOut("slow") }, 3000);

    $(document).ready(function () {
        var placeHolder = ['Ara..', 'Seri No..', 'Tarih..', 'Cihaz Modeli..', 'Alıcı İsmi..'];
        var n = 0;
...
document.getElementById("modalbase").onclick = function () {
    if (event.target != document.getElementById("modal") && event.target != document.getElementById("modalheader") && event.target != document.getElementsByClassName("buttons")[0] && event.target != document.getElementsByClassName("button-group")[0]) {
        modalhide();
    }
}
...
ipcRenderer.on("noconn", (e, data) => {
    ...
    document.getElementById("wifi").setAttribute("title", "Sunucu Bağlantısı Yok.")
    document.getElementById("tbody").innerHTML = "<td id='noconn' colspan='10' class='disabled text-center mx-auto text-danger' style='font-weight:400'>Sunucu Bağlantısı Yok.</td>"
    con = false;
...
function buttons() {
    var a = document.getElementById("printers"), b = document.getElementById("printeradd"), c = document.getElementById("logs");
...
function panels(e) {
    ...
    var a = document.getElementById("printersc"), b = document.getElementById("printeraddsc"), c = document.getElementById("logsc");
